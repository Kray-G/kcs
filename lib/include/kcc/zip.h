...
int zip_entry_write(zip_t *ent, const char *name, const void *buf, size_t bufsize);
int zip_entry_write_from_file(zip_t *ent, const char *filename);
