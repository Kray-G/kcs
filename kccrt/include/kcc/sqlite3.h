...
extern int sqlite3_bind_null(sqlite3_t *db, int index);
extern int sqlite3_bind_blob(sqlite3_t *db, int index, void *blob, int len, int mkcopy);
extern int sqlite3_bind_double(sqlite3_t *db, int index, double val);
extern int sqlite3lib_bind_int(sqlite3_t *db, int index, int val);
extern int sqlite3_bind_text(sqlite3_t *db, int index, const char *val, int len);
