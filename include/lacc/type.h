...
typedef struct {
    ...
    uint32_t is_pointer_const : 1;
    uint32_t is_pointer_volatile : 1;
    uint32_t is_pointer_restrict : 1;
    int32_t ref : 16;
} Type;
...
#define is_short(t) (type_of(t) == T_SHORT)
#define is_int(t) (type_of(t) == T_INT)
#define is_long(t) (type_of(t) == T_LONG)
...
/* Get a new type object with same information. */
