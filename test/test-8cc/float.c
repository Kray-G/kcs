...
char *fmtflt(float x) { return fmt("%a", x); }
...
void std() {
    ...
    expect_string("0x1.0000000000000p-23", fmtflt(FLT_EPSILON));
    ...
    expect_string("0x1.0000000000000p-126", fmtflt(FLT_MIN));
    expect_string("-37", fmtint(FLT_MIN_10_EXP));
    expect_string("-125", fmtint(FLT_MIN_EXP));
    expectd(*(float *)&(uint32_t){1}, FLT_TRUE_MIN);
    expect_string("0x1.0000000000000p-149", fmtflt(FLT_TRUE_MIN));

    expect_string("15", fmtint(DBL_DIG));
    expect_string("0x1.0000000000000p-52", fmtdbl(DBL_EPSILON));
    ...
    expect_string("0x1.0000000000000p-1022", fmtdbl(DBL_MIN));
