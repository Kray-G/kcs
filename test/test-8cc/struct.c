...
static void test_offsetof() {
    ...
    expect(8, offsetof(struct { char a[3]; int : 10; char c; }, c));
    expect(8, offsetof(struct { char a[3]; int : 16; char c; }, c));
    expect(8, offsetof(struct { char a[3]; int : 17; char c; }, c));
    expect(4, offsetof(struct { char : 7; int : 7; char a; }, a));
